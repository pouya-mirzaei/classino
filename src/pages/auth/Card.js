...
export default function Card() {
  return (
    <div className="card">
      ...
      <div className="side side-back -mt-[420px]">
        <UserInformationForm />
      </div>
    </div>
  );
...
function EmailForm({ form, toggle, nextStep }) {
  ...
  return (
	...
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
          ...
          <button className="text-primary-1 font-bold text-xs" type="button">
            اکانت دارید ؟ ورود
          </button>
        </form>
  ...
  return (
    <div className="bg-[#f6f8fc] max-w-md w-[400px] mx-5 relative z-20 rounded-lg">
      <div className="relative w-full z-10 rounded-lg bg-white flex items-center flex-col gap-5 p-5">
        <form className="w-full flex flex-col items-center gap-5" autoComplete="off">

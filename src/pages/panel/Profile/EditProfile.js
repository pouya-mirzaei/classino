...
export default function EditProfile() {
  ...
  const { uploadFile, getImagePublicUrl } = useStorage();
      ...
      <form className="space-y-8" onSubmit={form.handleSubmit}>
        <div>
          ...
          <input
            ...
            autoComplete="off"
          />
          {form.touched.mobile && form.errors.mobile && <span className="text-red-500 text-[10px]">{form.errors.mobile}</span>}
        </div>
        ...
        <div>
          ...
          {form.touched.gender && form.errors.gender && <span className="text-red-500 text-[10px]">{form.errors.gender}</span>}
        </div>
        <div>

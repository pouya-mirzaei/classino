...
export default function Timer() {
  ...
  return (
    <div className="basis-7/12 w-full bg-white rounded-xl shadow-md shadow-black/20">
      <div className="p-5">
        <h2 className="text-center text-base font-semibold">زمان باقی مانده تا کنکور 1403</h2>
        {/* count down */}
        <div className="flex flex-row-reverse justify-center gap-2 mt-4">
          ...
          <div className="flex flex-col items-center gap-y-2">
            ...
            <span className="text-gray-500 text-sm ">دقیقه</span>
          </div>
          <span className="text-[#baa7a8] text-2xl font-bold">:</span>
          <div className="flex flex-col items-center gap-y-2">
            <span className="text-[#20bf6b] text-2xl font-bold">{seconds}</span>
            <span className="text-gray-500 text-sm ">ثانیه</span>
          </div>
        </div>
        {/* progress */}
        <div className="flex flex-col justify-center items-center">
          <div className="my-6">
            <h3 className="text-sm text-center font-semibold">{percentageLeft}% از زمان شما باقی مانده </h3>
          </div>
          <div className="relative w-[90%] h-5 bg-gray-300 rounded-xl">
            <div
